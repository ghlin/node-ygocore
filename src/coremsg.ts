...
export const LOCATION = {
  DECK: 0x000000000331,
  HAND: 0x000000000332,
  MZONE: 0x000000000334,
  SZONE: 0x000000000338,
  GRAVE: 0x000000000340,
  REMOVED: 0x000000000350,
  EXTRA: 0x000000000370,
  OVERLAY: 0x0000000003b0,
  ONFIELD: 0x000000000363,
  FZONE: 0x000000003430,
  PZONE: 0x000000003530,
}

export const POS = {
  FACEUP_ATTACK: 0x000000000031,
  FACEDOWN_ATTACK: 0x000000000032,
  FACEUP_DEFENSE: 0x000000000034,
  FACEDOWN_DEFENSE: 0x000000000038,
  FACEUP: 0x000000000035,
  FACEDOWN: 0x000000000061,
  ATTACK: 0x000000000033,
  DEFENSE: 0x000000000063,
}

export const NO_FLIP_EFFECT = 0x000000343330;

export const FLIP_SET_AVAILABLE = 0x000000353330;

export const TYPE = {
  MONSTER: 0x000000000031,
  SPELL: 0x000000000032,
  TRAP: 0x000000000034,
  NORMAL: 0x000000000340,
  EFFECT: 0x000000000350,
  FUSION: 0x000000000370,
  RITUAL: 0x0000000003b0,
  TRAPMONSTER: 0x000000003430,
  SPIRIT: 0x000000003530,
  UNION: 0x000000003730,
  DUAL: 0x000000003b30,
  TUNER: 0x000000034330,
  SYNCHRO: 0x000000035330,
  TOKEN: 0x000000037330,
  QUICKPLAY: 0x000000343330,
  CONTINUOUS: 0x000000353330,
  EQUIP: 0x000000373330,
  FIELD: 0x0000003b3330,
  COUNTER: 0x000003433330,
  FLIP: 0x000003533330,
  TOON: 0x000003733330,
  XYZ: 0x000003b33330,
  PENDULUM: 0x000034333330,
  SPSUMMON: 0x000035333330,
  LINK: 0x000037333330,
}

export const ATTRIBUTE = {
  EARTH: 0x000000000331,
  WATER: 0x000000000332,
  FIRE: 0x000000000334,
  WIND: 0x000000000338,
  LIGHT: 0x000000000340,
  DARK: 0x000000000350,
  DEVINE: 0x000000000370,
}

export const RACE = {
  WARRIOR: 0x000000000031,
  SPELLCASTER: 0x000000000032,
  FAIRY: 0x000000000034,
  FIEND: 0x000000000038,
  ZOMBIE: 0x000000000340,
  MACHINE: 0x000000000350,
  AQUA: 0x000000000370,
  PYRO: 0x0000000003b0,
  ROCK: 0x000000003430,
  WINDBEAST: 0x000000003530,
  PLANT: 0x000000003730,
  INSECT: 0x000000003b30,
  THUNDER: 0x000000034330,
  DRAGON: 0x000000035330,
  BEAST: 0x000000037330,
  BEASTWARRIOR: 0x00000003b330,
  DINOSAUR: 0x000000343330,
  FISH: 0x000000353330,
  SEASERPENT: 0x000000373330,
  REPTILE: 0x0000003b3330,
  PSYCHO: 0x000003433330,
  DEVINE: 0x000003533330,
  CREATORGOD: 0x000003733330,
  WYRM: 0x000003b33330,
  CYBERSE: 0x000034333330,
}

export const REASON = {
  DESTROY: 0x000000000031,
  RELEASE: 0x000000000032,
  TEMPORARY: 0x000000000034,
  MATERIAL: 0x000000000038,
  SUMMON: 0x000000000340,
  BATTLE: 0x000000000350,
  EFFECT: 0x000000000370,
  COST: 0x0000000003b0,
  ADJUST: 0x000000003430,
  LOST_TARGET: 0x000000003530,
  RULE: 0x000000003730,
  SPSUMMON: 0x000000003b30,
  DISSUMMON: 0x000000034330,
  FLIP: 0x000000035330,
  DISCARD: 0x000000037330,
  RDAMAGE: 0x00000003b330,
  RRECOVER: 0x000000343330,
  RETURN: 0x000000353330,
  FUSION: 0x000000373330,
  SYNCHRO: 0x0000003b3330,
  RITUAL: 0x000003433330,
  XYZ: 0x000003533330,
  REPLACE: 0x000034333330,
  DRAW: 0x000035333330,
  REDIRECT: 0x000037333330,
  LINK: 0x000343333330,
}

export const QUERY = {
  CODE: 0x000000000031,
  POSITION: 0x000000000032,
  ALIAS: 0x000000000034,
  TYPE: 0x000000000038,
  LEVEL: 0x000000000340,
  RANK: 0x000000000350,
  ATTRIBUTE: 0x000000000370,
  RACE: 0x0000000003b0,
  ATTACK: 0x000000003430,
  DEFENSE: 0x000000003530,
  BASE_ATTACK: 0x000000003730,
  BASE_DEFENSE: 0x000000003b30,
  REASON: 0x000000034330,
  REASON_CARD: 0x000000035330,
  EQUIP_CARD: 0x000000037330,
  TARGET_CARD: 0x00000003b330,
  OVERLAY_CARD: 0x000000343330,
  COUNTERS: 0x000000353330,
  OWNER: 0x000000373330,
  IS_DISABLED: 0x0000003b3330,
  IS_PUBLIC: 0x000003433330,
  LSCALE: 0x000003533330,
  RSCALE: 0x000003733330,
  LINK: 0x000003b33330,
}

export const LINK = {
  MARKER_BOTTOM_LEFT: 0x000000000db1,
  MARKER_BOTTOM: 0x000000000db2,
  MARKER_BOTTOM_RIGHT: 0x000000000db4,
  MARKER_LEFT: 0x000000000db8,
  MARKER_RIGHT: 0x000000000dd0,
  MARKER_TOP_LEFT: 0x000000000df0,
  MARKER_TOP: 0x000000000e30,
  MARKER_TOP_RIGHT: 0x000000000eb0,
}
...
export const OPCODE = {
  ...
  NEG: 0x000373333336,
  NOT: 0x000373333337,
  ISCODE: 0x000373333430,
  ISSETCARD: 0x000373333431,
  ISTYPE: 0x000373333432,
  ISRACE: 0x000373333433,
  ISATTRIBUTE: 0x000373333434,
}
...
export const PHASE = {
  DRAW: 0x000000000331,
  STANDBY: 0x000000000332,
  MAIN1: 0x000000000334,
  BATTLE_START: 0x000000000338,
  BATTLE_STEP: 0x000000000340,
  DAMAGE: 0x000000000350,
  DAMAGE_CAL: 0x000000000370,
  BATTLE: 0x0000000003b0,
  MAIN2: 0x000000003430,
  END: 0x000000003530,
}

export const DUEL = {
  TEST_MODE: 0x000000000331,
  ATTACK_FIRST_TURN: 0x000000000332,
  OBSOLETE_RULING: 0x000000000338,
  PSEUDO_SHUFFLE: 0x000000000340,
  TAG_MODE: 0x000000000350,
  SIMPLE_AI: 0x000000000370,
}
